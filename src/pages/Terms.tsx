...
const Terms = () => (
  <LegalPageLayout title="Terms of Service">
    ...
    <p>Ledgera is a South African accounting and tax operations platform designed to help users manage financial records, invoices, documents, VAT support workflows, tax summaries, reports, and related business data.</p>

    <h2>2. Who may use Ledgera</h2>
    <ul><li>you are legally capable of entering into a binding agreement</li><li>you provide accurate registration information</li><li>you use the platform for lawful purposes</li><li>you comply with these Terms and all applicable laws</li></ul>

    <h2>3. User accounts</h2>
    <p>You are responsible for:</p>
    <ul><li>keeping your login credentials secure</li><li>controlling access to your account</li><li>ensuring the information in your account is accurate</li><li>promptly notifying us of suspected unauthorised access or security concerns</li></ul>
    ...
    <ul><li>the accuracy and legality of the information you upload or create</li><li>obtaining any required authority or consent for third-party data</li><li>reviewing invoices, tax calculations, exports, and records before relying on them</li><li>using the platform appropriately for your business</li></ul>
    <p>Ledgera is a software tool. It does not replace professional legal, tax, accounting, or audit advice.</p>

    <h2>6. Financial, tax, and compliance disclaimer</h2>
    <ul><li>Ledgera does not file directly with SARS on your behalf</li><li>Ledgera does not guarantee that every output is legally sufficient for every user or every fact pattern</li><li>Ledgera does not act as your accountant, auditor, attorney, or tax practitioner</li><li>you are responsible for reviewing and approving all records, returns, invoices, and submissions before use or filing</li></ul>

    <h2>7. Acceptable use</h2>
    <p>You may not use Ledgera to:</p>
    ...
    <p>We aim to keep Ledgera available and functioning reliably, but we do not guarantee uninterrupted or error-free service.</p>

    <h2>11. Backups, exports, and records</h2>
    <p>Ledgera may provide reporting, export, and document-retrieval features. You remain responsible for:</p>
    <ul><li>checking the correctness of exported records</li><li>storing exported records securely</li><li>keeping any records you are legally required to retain</li><li>verifying tax and accounting outputs before use</li></ul>

    <h2>12. Termination or suspension</h2>
    <p>We may suspend or terminate access where reasonably necessary. You may stop using the platform at any time, subject to applicable terms.</p>
    ...
    <p>We may update the platform and these Terms from time to time. The latest version will apply from the date published.</p>
