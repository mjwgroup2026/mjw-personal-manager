    ...
    return (
      <div className="flex min-h-screen items-center justify-center" style={{ background: '#0D1B2A' }}>
        <div className="flex items-center gap-3">
          <img src={ledgeraLogo} alt="Ledgera" className="h-10 w-10 animate-pulse" />
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 flex-col justify-between lg:flex" style={{ background: '#0D1B2A' }}>
        <div className="p-10">
          <div className="flex items-center gap-3">
            <img src={ledgeraLogo} alt="Ledgera" className="h-11 w-11" />
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-10">
          <img src={ledgeraLogo} alt="Ledgera" className="h-40 w-40 mb-8 drop-shadow-2xl" />
      ...
      <div className="flex flex-1 flex-col bg-background">
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
          ...
          <div className="mb-8 flex flex-col items-center gap-3 lg:hidden">
            <img src={ledgeraLogo} alt="Ledgera" className="h-24 w-24 mb-2" />
